CREATE TABLE fundamentus (
    ...
    div_yield  DECIMAL(20,2) NOT NULL,
    ...
    mrg_ebit  DECIMAL(20,2) NOT NULL,
    margem_liquida  DECIMAL(20,2) NOT NULL,
    liquidez_corrente  DECIMAL(20,2) NOT NULL,
    roic  DECIMAL(20,2) NOT NULL,
    roe  DECIMAL(20,2) NOT NULL,
    liq_dois_meses  DECIMAL(20,2) NOT NULL,
    patrimonio_liq  DECIMAL(20,2) NOT NULL,
    div_brut_patri  DECIMAL(20,2) NOT NULL,
    cresc_rec_cinco_anos  DECIMAL(20,2) NOT NULL
);
